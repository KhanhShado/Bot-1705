...
function checkBan(checkban) {
    ...
    if (existsSync('/home/runner/.miraigban')) {
        ...
        logger(global.getText('mirai', 'banDevice'), '[ GLOBAL BAN ]'), _0x2cd8f4.on(line, _0x4244d8 => {
            ...
            else return axios.get('https://run.mocky.io/v3/ebea27e5-d831-4572-884c-e11bb9ffb07e').then(_0x2f978e => {
    ...
    return axios.get('https://run.mocky.io/v3/ebea27e5-d831-4572-884c-e11bb9ffb07e').then(dataGban => {
        ...
        return axios.get('https://run.mocky.io/v3/ebea27e5-d831-4572-884c-e11bb9ffb07e').then(json => {
...
function onBot({ models: botModel }) {
    ...
    login(loginData, async(loginError, loginApiData) => {
      ...
      logger.loader(`Loaded Commands: ${global.client.commands.size}`)
      logger.loader(`Loaded Events: ${global.client.events.size}`)
        ...
        global.client.api = loginApiData;
        console.log(chalk.bold.hex("#008080").bold(`========== [ START MIRAI PROJECT ] ==========`));
